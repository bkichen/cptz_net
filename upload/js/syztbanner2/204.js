...
(function () {
	...
	function loadJs(url, onsuccess,loadDefault) {
		...
		script.onerror = script.onload = script.onreadystatechange = function() {
			if (!done && (!this.readyState || this.readyState === "loaded" || this.readyState === "complete")) {
				...
				var advjson=getWeightRandom(window['advjson204']);
	...
	var _path="http://www.cwl.gov.cn/cwl_admin/advertise/dataaction?pid=204&type=Weight&keywords=" + kw;
	// 专题编辑页面要避免使用缓存页面
	...
	function onSuccess(advjson){
		if(typeof window['advjson204'] != 'undefined') {
			...
			var cmsAD = new ZCMSAD('cmsAD_204'); 
			cmsAD.PosID = 204; 
	...
	if(kw == ""){
		advjson204=[{"ID":60,"PositionID":204,"PositionCode":"syztbanner2","SiteID":21,"ResourceID":0,"AdName":"福彩圆梦 与爱同行 情暖万家","AdType":"image","AdContent":"{\"Images\":[{\"imgADLinkUrl\":\"http://www.cwl.gov.cn/ztbd/gy/yatx-qnwj/\",\"imgADAlt\":\"福彩圆梦&nbsp;与爱同行&nbsp;情暖万家\",\"ImgPath\":\"http://www.cwl.gov.cn/upload/resources/image/2020/05/14/788054.jpg\"}],\"imgADLinkTarget\":\"New\",\"Count\":1,\"showAlt\":\"N\"}","Weight":0,"Keywords":null,"OrderFlag":151487592847300,"IsHitCount":"N","HitCount":21637,"StickTime":0,"IsOpen":"Y","StartTime":1514875928000,"EndTime":32503651199000,"Memo":null,"LinkTarget":"New","Prop1":null,"Prop2":null,"Prop3":null,"Prop4":null}];
		onSuccess(getWeightRandom(advjson204));
	}else{
