...
(function () {
	...
	function loadJs(url, onsuccess,loadDefault) {
		...
		script.onerror = script.onload = script.onreadystatechange = function() {
			if (!done && (!this.readyState || this.readyState === "loaded" || this.readyState === "complete")) {
				...
				var advjson=getWeightRandom(window['advjson205']);
	...
	var _path="http://www.cwl.gov.cn/cwl_admin/advertise/dataaction?pid=205&type=Weight&keywords=" + kw;
	// 专题编辑页面要避免使用缓存页面
	...
	function onSuccess(advjson){
		if(typeof window['advjson205'] != 'undefined') {
			...
			var cmsAD = new ZCMSAD('cmsAD_205'); 
			cmsAD.PosID = 205; 
	...
	if(kw == ""){
		advjson205=[{"ID":61,"PositionID":205,"PositionCode":"syztbanner3","SiteID":21,"ResourceID":0,"AdName":"彩票公益金使用管理信息","AdType":"image","AdContent":"{\"Images\":[{\"imgADLinkUrl\":\"http://www.cwl.gov.cn/ztbd/gy/cpgyjsyglxx/\",\"imgADAlt\":\"情聚一线&nbsp;心手相牵\",\"ImgPath\":\"http://www.cwl.gov.cn/upload/resources/image/2018/12/04/310720.jpg\"}],\"imgADLinkTarget\":\"New\",\"Count\":1,\"showAlt\":\"N\"}","Weight":0,"Keywords":null,"OrderFlag":151487600209800,"IsHitCount":"N","HitCount":15572,"StickTime":0,"IsOpen":"Y","StartTime":1514876002000,"EndTime":32503651199000,"Memo":null,"LinkTarget":"New","Prop1":null,"Prop2":null,"Prop3":null,"Prop4":null}];
		onSuccess(getWeightRandom(advjson205));
	}else{
