...
(function () {
	...
	function loadJs(url, onsuccess,loadDefault) {
		...
		script.onerror = script.onload = script.onreadystatechange = function() {
			if (!done && (!this.readyState || this.readyState === "loaded" || this.readyState === "complete")) {
				...
				var advjson=getWeightRandom(window['advjson202']);
	...
	var _path="http://www.cwl.gov.cn/cwl_admin/advertise/dataaction?pid=202&type=Weight&keywords=" + kw;
	// 专题编辑页面要避免使用缓存页面
	...
	function onSuccess(advjson){
		if(typeof window['advjson202'] != 'undefined') {
			...
			var cmsAD = new ZCMSAD('cmsAD_202'); 
			cmsAD.PosID = 202; 
	...
	if(kw == ""){
		advjson202=[{"ID":59,"PositionID":202,"PositionCode":"syztbanner1","SiteID":21,"ResourceID":0,"AdName":"感恩有你 一路相伴","AdType":"image","AdContent":"{\"Images\":[{\"imgADLinkUrl\":\"http://www.cwl.gov.cn/ztbd/qt/fcgeyn/\",\"imgADAlt\":\"感恩有你&nbsp;一路相伴\",\"ImgPath\":\"http://www.cwl.gov.cn/upload/resources/image/2020/04/01/786052.jpg\"}],\"imgADLinkTarget\":\"New\",\"Count\":1,\"showAlt\":\"N\"}","Weight":0,"Keywords":null,"OrderFlag":151487583341800,"IsHitCount":"N","HitCount":21087,"StickTime":0,"IsOpen":"Y","StartTime":1514875833000,"EndTime":32503651199000,"Memo":null,"LinkTarget":"New","Prop1":null,"Prop2":null,"Prop3":null,"Prop4":null}];
		onSuccess(getWeightRandom(advjson202));
	}else{
