...
(function () {
	...
	function loadJs(url, onsuccess,loadDefault) {
		...
		script.onerror = script.onload = script.onreadystatechange = function() {
			if (!done && (!this.readyState || this.readyState === "loaded" || this.readyState === "complete")) {
				...
				var advjson=getWeightRandom(window['advjson206']);
	...
	var _path="http://www.cwl.gov.cn/cwl_admin/advertise/dataaction?pid=206&type=Weight&keywords=" + kw;
	// 专题编辑页面要避免使用缓存页面
	...
	function onSuccess(advjson){
		if(typeof window['advjson206'] != 'undefined') {
			...
			var cmsAD = new ZCMSAD('cmsAD_206'); 
			cmsAD.PosID = 206; 
			...
			cmsAD.Width = 235; 
			cmsAD.Height = 100; 
			cmsAD.URL = "http://www.cwl.gov.cn/cwl_admin/advertise/hitcount"; 
			cmsAD.ShowAD();
	...
	if(kw == ""){
		advjson206=[{"ID":75,"PositionID":206,"PositionCode":"syztbanner4","SiteID":21,"ResourceID":0,"AdName":"1987-2019年福利彩票发行量、筹集公益金数量统计表","AdType":"image","AdContent":"{\"Images\":[{\"imgADLinkUrl\":\"http://www.cwl.gov.cn/c/2020-01-13/449643.shtml\",\"imgADAlt\":\"\",\"ImgPath\":\"http://www.cwl.gov.cn/upload/resources/image/2020/01/13/781425.jpg\"}],\"imgADLinkTarget\":\"New\",\"Count\":1,\"showAlt\":\"N\"}","Weight":0,"Keywords":null,"OrderFlag":155108018956400,"IsHitCount":"N","HitCount":1,"StickTime":0,"IsOpen":"Y","StartTime":1578893170000,"EndTime":32503651199000,"Memo":null,"LinkTarget":"New","Prop1":null,"Prop2":null,"Prop3":null,"Prop4":null}];
		onSuccess(getWeightRandom(advjson206));
	}else{
