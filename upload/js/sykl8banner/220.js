...
(function () {
	...
	function loadJs(url, onsuccess,loadDefault) {
		...
		script.onerror = script.onload = script.onreadystatechange = function() {
			if (!done && (!this.readyState || this.readyState === "loaded" || this.readyState === "complete")) {
				...
				var advjson=getWeightRandom(window['advjson220']);
	...
	var _path="http://www.cwl.gov.cn/cwl_admin/advertise/dataaction?pid=220&type=Weight&keywords=" + kw;
	// 专题编辑页面要避免使用缓存页面
	...
	function onSuccess(advjson){
		if(typeof window['advjson220'] != 'undefined') {
			...
			var cmsAD = new ZCMSAD('cmsAD_220'); 
			cmsAD.PosID = 220; 
	...
	if(kw == ""){
		advjson220=[{"ID":76,"PositionID":220,"PositionCode":"sykl8banner","SiteID":21,"ResourceID":0,"AdName":"快乐8频道页","AdType":"image","AdContent":"{\"Images\":[{\"imgADLinkUrl\":\"http://www.cwl.gov.cn/kjxx/kl8/\",\"imgADAlt\":\"\",\"ImgPath\":\"http://www.cwl.gov.cn/upload/resources/image/2020/10/26/796224.png\"}],\"imgADLinkTarget\":\"New\",\"Count\":1,\"showAlt\":\"N\"}","Weight":0,"Keywords":null,"OrderFlag":160310908474300,"IsHitCount":"N","HitCount":1,"StickTime":0,"IsOpen":"Y","StartTime":1603109084000,"EndTime":32503651199000,"Memo":null,"LinkTarget":"New","Prop1":null,"Prop2":null,"Prop3":null,"Prop4":null}];
		onSuccess(getWeightRandom(advjson220));
	}else{
