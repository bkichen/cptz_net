...
(function(root, factory) {
    ...
    Paging.prototype = {
        ...
        bindToolbar: function() {
            var _this = this;
            var html = $('<li class="ui-paging-toolbar">到第几<div><input type="text" class="ui-paging-count"/>页</div><a href="javascript:void(0)">确定</a></li>"');
            ...
            $('a', html).click(function() {
                var current = parseInt($(".ui-paging-count").val()) || 1;
                _this.go(current);
            });
            sel.change(function() {
